...
namespace UltimateBaseball
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            guesses[0] = int.Parse(Console.ReadLine());            // 구) int guess1 = int.Parse(Console.ReadLine());
            Console.WriteLine("> 두 번째 숫자를 입력하세요.");
            guesses[1] = int.Parse(Console.ReadLine());            // 구) int guess2 = int.Parse(Console.ReadLine());
            Console.WriteLine("> 세 번째 숫자를 입력하세요.");
            guesses[2] = int.Parse(Console.ReadLine());            // 구) int guess3 = int.Parse(Console.ReadLine());
                        
            Console.WriteLine("> 공격수가 고른 숫자");
            Console.WriteLine(guesses[0]); // 구) Console.WriteLine(guess1);
            Console.WriteLine(guesses[1]); // 구) Console.WriteLine(guess2);
            Console.WriteLine(guesses[2]); // 구) Console.WriteLine(guess3);

            if (guesses[0] == guesses[1] || guesses[0] == guesses[2] || guesses[1] == guesses[2]) // 구) if (guess1 == guess2 || guess1 == guess3)
            {
            ...
            else
            {
                ...
                if (guesses[0] == numbers[0]) // 구) (guess1 == number1)
                {
