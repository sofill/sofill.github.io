...
public class WordHandler {
  ...
  public void addWord() {
    ...
    for (int i = 0; i < WORD_SIZE; i++) {
      ...
      temp.lang = input.nextLine();

      System.out.print("3.단어: ");
      temp.word = input.nextLine();

      System.out.print("4.의미: ");
      temp.meaning = input.nextLine();

      System.out.print("5.품사: ");
      temp.wordClass = input.nextLine();

      System.out.print("6.인용: ");
      temp.quote = input.nextLine();

      System.out.print("7.번역: ");
      temp.translation = input.nextLine();

      System.out.print("8.메모: ");
      temp.memo = input.nextLine();
